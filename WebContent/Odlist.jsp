	...
	<div class="container">
			...
			<div class="col-md-12">
				...
				<div class="collapse navbar-collapse navbar-collapse-01">
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="active"><a href="allorderaction.action">Orderlist</a></li>
		...
		<div class="panel panel-default">
			...
			<table class="table">
				...
				<tbody>
					<s:iterator value="#request.olist" id="us">
						<tr>
							<td><s:property value="#us.orderid" /></td>
                    	...
                    	Sold
							...
							<td><s:a href="ordersell.action?oid=%{#us.orderid}">Selllll</s:a></td>
						</tr>
