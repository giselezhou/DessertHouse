...
.navbar {
	...
	<div class="container">
			...
			<div class="col-md-12">
				...
				<div class="collapse navbar-collapse navbar-collapse-01">
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="active"><a href="allcpaction.action">CommodityPlansShow</a></li>
		...
		<div class="panel panel-default">
			...
			<div class="panel-heading">Commodity List</div>
			...
			<table class="table">
				...
				<tbody>
					<s:iterator value="#request.list" id="us">
						<tr>
							<td><s:property value="#us.commdityplanid" /></td>
							<td><s:if test="#us.status != 1">
                    	Waiting
                    	...
                    	Permit
							...
							<td><s:property value="#us.commdityid" /></td>
							<td><s:a
									href="permitaction.action?cpid=%{#us.commdityplanid}">Permit</s:a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
