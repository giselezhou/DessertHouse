...
<body>
	<div class="container">
		<img alt="140x140" src="img/white.png" />
		<p class="lead col-md-4 col-md-offset-4" style="font-family:courier">
			<font color="#E74C3C"> <span
				class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
				<span class="sr-only">Error:</span> &nbsp;Sorry,&nbsp;failed
			</font>
		</p>
