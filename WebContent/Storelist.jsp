			...
			<div class="col-md-12">
				...
				<div class="collapse navbar-collapse navbar-collapse-01">
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="active"><a href="allstoreaction.action">StoreList</a></li>
				...
				<tbody>
					<s:iterator value="#request.slist" id="us">
                    	...
                    	BranchStore
							...
							<td><s:if test="#us.blto == 0">
                    	Main
                    	</s:if> <s:if test="#us.blto != 0">
									<s:property value="#us.blto" />
								</s:if></td>
							<td><s:property value="#us.storename" /></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
