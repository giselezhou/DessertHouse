...
#memberupd .row {
	...
	<div class="container">
			...
			<div class="col-md-12">
				...
				<div class="collapse navbar-collapse navbar-collapse-01">
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="active"><a href="MemberUpd.jsp">Member Info
								Update</a></li>
		...
		<div class="panel panel-default">
			<div class="panel-heading">Member Update Information</div>
			<img alt="140x140" src="img/white2.png" />
			<div class="row demo-row">

				<s:form action="memberupd">
					<div class="row">
					...
					<div class="submit">
						<button type="submit"
							...
							style="width: 280px">Update</button>
					</div>
				</s:form>
